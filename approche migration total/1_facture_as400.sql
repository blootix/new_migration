...
begin
	...
	for facture_ in fact_as400
	loop
	    for x in branch_(lpad(facture_.DIST, 2, '0') ,
			...
			V_pdl_ref := lpad(facture_.dist,2,'0') ||
			...
			if v_nbr=0 then 
				...
				New_genaccount.REC_ID    := null;-- Fac.REC_ID ;
