--drop table  MIG_PIVOT_06.miwtrib;
--create table  MIG_PIVOT_06.miwtrib as (select * from  MIG_PIVOT_06. MIG_PIVOT_06.miwtrib);
declare
  cursor c 
  is 
    select t.ban_id,m.par_id,t.mrib_titulaire,t.mrib_compte,m.mper_nom 
	from  MIG_PIVOT_06.miwtrib t, MIG_PIVOT_06.miwabn p, MIG_PIVOT_06.miwtpersonne m
...
begin
  ...
  for i in c loop
    ...
    update  MIG_PIVOT_06.miwtrib a set a.ban_id = nbr_BAP_ID;
