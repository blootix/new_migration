...
begin
  Update  mig_pivot_58.MIWTPERSONNE set VOC_TYPSAG =1  where VOC_TYPSAG is null ;
  Update  mig_pivot_58.MIWTPERSONNE set VOC_PARTYTP =1 where VOC_PARTYTP is null ;
  update  mig_pivot_58.miwtpersonne 
  ...
  select seq_genparty.nextval into Per_Id  from dual ;
    ...
    Update  mig_pivot_58.miwtpersonne set PAR_ID= v_ref_per ,ADR_ID =Per.ADR_ID ,
