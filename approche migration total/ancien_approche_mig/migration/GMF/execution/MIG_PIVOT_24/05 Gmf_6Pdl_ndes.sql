...
PROMPT ********************************************************/
SELECT to_char(sysdate, 'DD/MM/YY HH24:MI') heure FROM dual;
update   mig_pivot_24.miwtpdl set VOC_PREMISETP ='MA' where VOC_PREMISETP is null ;
--Update miwtpdl set 
--tecpresptcontact
/*PROMPT *******************************************************
...
Declare 
  ...
  select PDL_source         ,
         ...
         VOC_PREMISETP		,
		 p.PDL_DFERMETURE 
   from   mig_pivot_24.miwtadr a,
          mig_pivot_24.miwtpdl p, 
          mig_pivot_24.miwttournee t, 
         tecfluid f  
...
Declare
  ...
  is
    ...
    FROM    mig_pivot_24.miwtpdl p1,
            mig_pivot_24.miwtpdl p2 ,
           genvoc t ,
           genvocword d
...
Declare
  ...
  is
     ...
     FROM    mig_pivot_24.miwtpdl Pdl,
             mig_pivot_24.miwtbra Bra
