...
PROMPT ********************************************************/
SELECT to_char(sysdate, 'DD/MM/YY HH24:MI') heure FROM dual;
update   mig_pivot_55.miwtpdl set VOC_PREMISETP ='MA' where VOC_PREMISETP is null ;
--Update miwtpdl set 
--tecpresptcontact
/*PROMPT *******************************************************
...
Declare
  ...
  is
    ...
    FROM    mig_pivot_55.miwtpdl p1,
            mig_pivot_55.miwtpdl p2 ,
           genvoc t ,
           genvocword d
...
Declare
  ...
  is
     ...
     FROM    mig_pivot_55.miwtpdl Pdl,
             mig_pivot_55.miwtbra Bra
