--drop table  mig_pivot_55.miwtrib;
--create table  mig_pivot_55.miwtrib as (select * from  mig_pivot_55. mig_pivot_55.miwtrib);
declare
  cursor c 
  is 
    select t.ban_id,m.par_id,t.mrib_titulaire,t.mrib_compte,m.mper_nom 
	from  mig_pivot_55.miwtrib t, mig_pivot_55.miwabn p, mig_pivot_55.miwtpersonne m
...
begin
  ...
  for i in c loop
    ...
    update  mig_pivot_55.miwtrib a set a.ban_id = nbr_BAP_ID;
