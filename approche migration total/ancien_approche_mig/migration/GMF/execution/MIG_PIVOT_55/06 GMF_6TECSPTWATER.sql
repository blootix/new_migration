...
----------------------------------------------
------------------------------------------------------------------------
update  mig_pivot_55.miwtpdl l set l.VOC_CONSTATUS='I' where upper(trim(l.VOC_CONSTATUS)) not in('B','M','I');
update mig_pivot_55.miwtpdl l set l.VOC_CONNAT=0 where  to_char(trim(l.VOC_CONNAT)) not in('0','1','2','3');
...
is 
  ...
  from tecservicepoint t,  mig_pivot_55.miwtpdl m where m.spt_id=t.spt_id;
