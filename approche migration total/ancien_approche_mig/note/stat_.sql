...
drop table VERIF_CAlC_MIGRATION;
...
pdl integer, 
branchement integer ,
def_source_prod integer ,
site integer, 
contact_site_pdl integer, 
abonnement integer, 
contact_abonnement integer,
payeur integer,
adresse_facturation integer,
adresse integer,
historique_pose_compteur integer,
compteur integer,
histor_profil_facturation integer,
etat_pdl integer,
planning_facturation integer,
SECTORISATION integer,
affictation_pdl_organisation integer,
modilite_de_paiment integer,
compte_abonnement integer,
